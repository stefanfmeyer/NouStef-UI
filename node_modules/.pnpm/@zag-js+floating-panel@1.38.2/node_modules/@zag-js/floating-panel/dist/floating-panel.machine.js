  ...
  implementations: {
    ...
    actions: {
      setPosition({ context, event, prop, scope }) {
        ...
        const position = (0, import_rect_utils.clampPoint)(event.position, context.get("size"), boundaryRect);
      ...
      setSize({ context, event, scope, prop }) {
        ...
        const nextPosition = (0, import_rect_utils.clampPoint)(context.get("position"), nextSize, boundaryRect);
      ...
      setMaximized({ context, prop, scope }) {
        ...
        const boundaryEl = prop("getBoundaryEl")?.();
        const boundaryRect = dom.getBoundaryRect(scope, boundaryEl, false);
        const nextPosition = (0, import_utils.pick)(boundaryRect, ["x", "y"]);
        const nextSize = (0, import_utils.pick)(boundaryRect, ["height", "width"]);
      ...
      setRestored({ context, prop, scope }) {
        ...
        const prevSize = context.get("prevSize");
        if (prevSize) {
          restoredSize = (0, import_rect_utils.clampSize)(prevSize, prop("minSize"), prop("maxSize"));
          restoredSize = (0, import_rect_utils.clampSize)(restoredSize, prop("minSize"), boundaryRect);
        }
        let restoredPosition = context.get("position");
        const prevPosition = context.get("prevPosition");
        if (prevPosition) {
          restoredPosition = (0, import_rect_utils.clampPoint)(prevPosition, restoredSize, boundaryRect);
        }
