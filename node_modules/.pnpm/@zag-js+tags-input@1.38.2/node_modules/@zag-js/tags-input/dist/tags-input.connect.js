...
var tags_input_connect_exports = {};
__export(tags_input_connect_exports, {
  connect: () => connect
});
module.exports = __toCommonJS(tags_input_connect_exports);
  ...
  return {
    ...
    getRootProps() {
      return normalize.element({
        dir: prop("dir"),
        ...import_tags_input.parts.root.attrs,
    ...
    getLabelProps() {
      return normalize.label({
        ...import_tags_input.parts.label.attrs,
        "data-disabled": (0, import_dom_query.dataAttr)(disabled),
        "data-invalid": (0, import_dom_query.dataAttr)(invalid),
        "data-readonly": (0, import_dom_query.dataAttr)(readOnly),
    ...
    getControlProps() {
      return normalize.element({
        ...
        ...import_tags_input.parts.control.attrs,
        dir: prop("dir"),
    ...
    getInputProps() {
      return normalize.input({
        ...import_tags_input.parts.input.attrs,
        dir: prop("dir"),
        "data-invalid": (0, import_dom_query.dataAttr)(invalid),
    ...
    getItemProps(props) {
      return normalize.element({
        ...import_tags_input.parts.item.attrs,
        dir: prop("dir"),
    ...
    getItemPreviewProps(props) {
      ...
      return normalize.element({
        ...import_tags_input.parts.itemPreview.attrs,
        id: itemState.id,
        dir: prop("dir"),
    ...
    getItemTextProps(props) {
      const itemState = getItemState(props);
      return normalize.element({
        ...import_tags_input.parts.itemText.attrs,
        dir: prop("dir"),
        "data-disabled": (0, import_dom_query.dataAttr)(disabled),
        "data-highlighted": (0, import_dom_query.dataAttr)(itemState.highlighted)
      });
    ...
    getItemInputProps(props) {
      const itemState = getItemState(props);
      return normalize.input({
        ...import_tags_input.parts.itemInput.attrs,
        dir: prop("dir"),
    ...
    getItemDeleteTriggerProps(props) {
      ...
      return normalize.button({
        ...import_tags_input.parts.itemDeleteTrigger.attrs,
        dir: prop("dir"),
    ...
    getClearTriggerProps() {
      return normalize.button({
        ...import_tags_input.parts.clearTrigger.attrs,
        dir: prop("dir"),
