  ...
  implementations: {
    ...
    actions: {
      ...
      addTag({ context, event, computed, prop, refs }) {
        ...
        if (guard) {
          const nextValue = prop("allowDuplicates") ? value.concat(inputValue) : (0, import_utils.uniq)(value.concat(inputValue));
      ...
      addTagFromPaste({ context, computed, prop, refs }) {
        (0, import_dom_query.raf)(() => {
          ...
          if (guard) {
            ...
            const nextValue = prop("allowDuplicates") ? value.concat(...trimmedValue) : (0, import_utils.uniq)(value.concat(...trimmedValue));
            context.set("value", nextValue);
            const prevLog = refs.get("log");
            refs.set("log", {
              prev: prevLog.current,
