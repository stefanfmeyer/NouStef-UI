import { z } from 'zod';
import { RecipeTemplateBoardCardSchema, RecipeTemplateIdSchema, RecipeTemplateCardItemSchema, RecipeTemplateChipSchema, RecipeTemplateFieldSchema, RecipeTemplateListItemSchema, RecipeTemplateStatSchema, RecipeTemplateTableColumnSchema, RecipeTemplateTableRowSchema, RecipeTemplateTimelineItemSchema, RecipeTemplateToneSchema } from './recipe-template-schemas';
...
const StepByStepInstructionsActionsDataSchema = z
    ...
    .strict();
const createTemplateFillSchema = (templateId, dataSchema) => RecipeTemplateFillBaseSchema.extend({
...
const RecipeTemplateHydrationBaseSchema = z
    ...
    .strict();
const createTemplateHydrationSchema = (templateId, dataSchema) => RecipeTemplateHydrationBaseSchema.extend({
    templateId: z.literal(templateId),
    data: dataSchema
}).strict();
...
const RecipeTemplateTextBaseSchema = z
    ...
    .strict();
const createTemplateTextSchema = (templateId, dataSchema) => RecipeTemplateTextBaseSchema.extend({
    templateId: z.literal(templateId),
    data: dataSchema
}).strict();
...
const RecipeTemplateActionsBaseSchema = z
    ...
    .strict();
const createTemplateActionsSchema = (templateId, dataSchema) => RecipeTemplateActionsBaseSchema.extend({
    templateId: z.literal(templateId),
    data: dataSchema
}).strict();
...
const RecipeTemplateUpdateBaseSchema = z
    ...
    .strict();
const createTemplateUpdateSchema = (templateId) => RecipeTemplateUpdateBaseSchema.extend({
    templateId: z.literal(templateId)
}).strict();
