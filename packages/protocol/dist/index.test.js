...
import { AuditEventsResponseSchema, BootstrapResponseSchema, ChatStreamEventSchema, ChatStreamRequestSchema, CreateRecipeRequestSchema, DeleteSessionRequestSchema, DeleteRecipeRequestSchema, DeleteSkillRequestSchema, ExecuteRecipeActionRequestSchema, HermesCliActionResultSchema, HermesCliModelDiscoverySchema, JobSchema, ModelProviderResponseSchema, OpenRecipeChatResponseSchema, ProfileSchema, RenameSessionRequestSchema, RuntimeRequestSchema, RecipeActionSpecSchema, RecipeAnalysisSchema, RecipeArtifactSchema, RecipeBuildSchema, RecipeDynamicStateSchema, RecipeFallbackStateSchema, RecipeIntentSchema, RecipeMetadataSchema, RecipeNormalizedDataSchema, SessionDeletionResponseSchema, SessionMessagesResponseSchema, SessionSchema, RecipeContentEntrySchema, RecipeSummarySchema, RecipeTestResultsSchema, RecipeTestSpecSchema, RecipeUiSpecSchema, RecipeUserPromptArtifactSchema, RecipeRawDataSchema, RecipeAssistantContextSchema, RecipeResponseSchema, RecipesResponseSchema, SkillDeletionResponseSchema, SettingsResponseSchema, SkillSchema, TelemetryResponseSchema, ToolExecutionPrepareRequestSchema, ToolSchema, UiStateSchema, RecipeDslSchema, RecipeModelSchema, RecipePatchSchema } from './index';
import { getRecipeContentEntries, getRecipeContentFormat, getRecipeContentTab, getRecipeContentViewData, isRecipeContentSynchronized, normalizeLegacyRecipeTabs, removeRecipeContentEntries, normalizeRecipeTabs } from './recipe-helpers';
describe('protocol schemas', () => {
    ...
    it('parses the structured Hermes CLI model discovery contract strictly', () => {
        ...
        expect(() => HermesCliModelDiscoverySchema.parse({
            ...discovery,
            extra: true
        })).toThrowError();
    });
    ...
    it('parses the structured Hermes CLI action contract strictly', () => {
        ...
        expect(() => HermesCliActionResultSchema.parse({
            ...action,
            unexpected: 'field'
        })).toThrowError();
    });
...
- Point two`
    ...
    it('rejects malformed aligned content entries whose card id does not match the entry id', () => {
        expect(() => RecipeContentEntrySchema.parse({
            id: 'entry-1',
            md: '### Launch follow-up',
            row: {
                subject: 'Launch follow-up'
    ...
    it('rejects removed todoData fields on recipe create/update payloads', () => {
        expect(() => CreateRecipeRequestSchema.parse({
            profileId: 'jbarton',
            sessionId: 'session-1',
