export function visitRecipeAppletNodes(nodes, visitor) {
...
export function collectRecipeAppletNodeKinds(tree) {
    const kinds = [];
...
export function collectRecipeAppletActionIds(tree) {
...
export function validateRecipeAppletSmallPane(tree) {
    const errors = [];
    visitRecipeAppletNodes(tree.root, (node) => {
        switch (node.kind) {
            case 'grid':
