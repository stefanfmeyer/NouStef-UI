import { RecipeAppletPlanSchema, RecipeAppletSourceArtifactSchema } from '@hermes-recipes/protocol';
...
export function synthesizeRecipeAppletPlan(manifest, options = {}) {
...
export function extractRecipeAppletSource(responseText) {
    const warnings = [];
    const errors = [];
