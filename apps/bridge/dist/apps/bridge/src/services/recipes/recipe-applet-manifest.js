...
function collectionExists(collectionId, recipeModel, normalizedData) {
...
export function synthesizeRecipeAppletManifest(input) {
    ...
    const manifest = RecipeAppletManifestSchema.parse({
        ...
        description: input.recipe.description?.trim() ||
